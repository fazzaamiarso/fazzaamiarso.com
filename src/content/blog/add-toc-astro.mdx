...
tags: ["astro", "tutorial"]
description: "Let's create a table of content for your blog post with Astro framework"
---
import SideNote from "@/components/project/side-note.astro";

<SideNote headingText="Disclaimer" variants="danger">
    This is an old blog post that uses the older version of Astro framework. There are a lot of breaking changes over the years, so things might not worked as expected today.
</SideNote>
