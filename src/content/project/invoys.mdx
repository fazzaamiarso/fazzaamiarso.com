...
relatedProjects:
  - foodhunt
  - lampung-begawi
thumbnail: https://res.cloudinary.com/dkiqn0gqg/image/upload/f_auto/q_auto/v1720383613/fazzaamiarso.com-astro/projects/invoys/invoys-logo_rdsrbn.webp
---

import { Image } from "astro:assets";
import SplitImage, { SplitContent } from "@/components/project/split-image/split-image";
import ImageItem from "@/components/project/split-image/split-image-wrapper.astro";
import VideoPlayer from "@/components/project/video-player.astro";
import SideNote from "@/components/project/side-note.astro";

<SideNote headingText="Disclaimer">
  The live site can't be accessed anymore because Planetscale removed its Free tier. It causes the
  database to sleep unless upgraded into paid tier (I don't have plan to migrate the database
  provider anytime soon too). Please refer to the demo video to see the app's functionality.
</SideNote>
...
<VideoPlayer src="https://res.cloudinary.com/dkiqn0gqg/video/upload/f_auto/q_auto/v1720450939/fazzaamiarso.com-astro/projects/invoys/Invoys___Courier_Hacks_Open_Source_720p60_dfmke0.mp4" />
...
<SplitImage>
  <SplitContent>
    <ImageItem src="https://i.imgur.com/fdeh97j.png" />
    <ImageItem src="https://i.imgur.com/1EulVHE.png" />
    <ImageItem src="https://camo.githubusercontent.com/e3bf1451b0e3b335ef7280f5bc84f79ddb0d6fdc31d1670e1dddac9b183ace2e/68747470733a2f2f692e696d6775722e636f6d2f665675734b72372e706e67" />
  </SplitContent>
  <SplitContent>
    <ImageItem src="https://i.imgur.com/T42iGGj.png" />
    <ImageItem src="https://i.imgur.com/ujWxXj5.png" />
    <ImageItem src="https://camo.githubusercontent.com/be08edf3288726c64b6fb9218f440c462e0b3469466330d9878990881f0632c0/68747470733a2f2f692e696d6775722e636f6d2f7270446f72304d2e676966" />
  </SplitContent>
</SplitImage>
...
An important takeaway is just try to build it first, if stuck then put it off for later. Before that, I was doing too much calculations before trying something (e.g. library), it turns out by trying I can learn and fail much faster.@/components/project/split-image/split-image
